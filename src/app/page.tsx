  ...
  if (!isMounted) {
    return (
      ...
      <div className="container mx-auto px-3 xs:px-4 sm:px-6 py-8 xs:py-10 sm:py-12">
        <h2 className="text-2xl xs:text-3xl sm:text-4xl font-bold text-primary mb-8 xs:mb-10 sm:mb-12">Наши товары</h2>
    ...
    <div>
      ...
      <div className="container mx-auto px-3 xs:px-4 sm:px-6 py-8 xs:py-10 sm:py-12">
        <div className="flex items-center justify-between mb-8 xs:mb-10 sm:mb-12">
          <h2 className="text-2xl xs:text-3xl sm:text-4xl font-bold text-primary">
            {getPageTitle()}
          </h2>
