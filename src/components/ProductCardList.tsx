...
export default function ProductCardList({ product, onCategoryClick, selectedCategories = [], onEditProduct, onDeleteProduct }: ProductCardListProps) {
  ...
  return (
    <div className="card-hover p-3 xs:p-4 group relative">
      {/* Админ-кнопки */}
      {isMounted && isAdmin() && (
